...
class LEVELDB_EXPORT Env {
 public:
  ...
  // serialized.
  virtual void Schedule(void (*function)(void* arg,bool flag), void* arg,bool flag) = 0;
...
class LEVELDB_EXPORT EnvWrapper : public Env {
 public:
  ...
  void Schedule(void (*f)(void*,bool), void* a,bool flag) override {
    return target_->Schedule(f, a, flag);
  }
